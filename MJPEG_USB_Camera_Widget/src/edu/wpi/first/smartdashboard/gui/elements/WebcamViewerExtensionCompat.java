 ...
 * @author Tom Clark
 */
public class WebcamViewerExtensionCompat extends StaticWidget implements Runnable {
    ...
    public void run() {
        ...
        for (;;)
            try {
                ...
                final int framesize = (int)sizeProperty.getValue();
                ...
                while (!Thread.interrupted() &&
                        framesize == (int)sizeProperty.getValue()) {
